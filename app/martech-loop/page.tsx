...
const MOCK: Record<"alpha" | "beta", CampaignData> = {
  alpha: {
    creativeA: {
      ...
      copy: "身處海外，仲憂慮資產貶值？保誠環球貨幣保障計劃幫你喺全球市場鎖定升值機遇，首年保費享10%折扣，立即行動！",
      cta: "立即了解更多",
    ...
    creativeB: {
      ...
      copy: "數據顯示：20-40歲海外理財客群平均每年損失8.3%匯率差額。保誠環球貨幣保障計劃透過多幣種配置對沖風險，首批客戶限享10%保費折扣。",
      cta: "免費獲取個人化方案",
      platforms: ["Facebook Ad Integrated", "Instagram Post Ready"],
      ctr: 6.8,
      bounce: 32,
  ...
  beta: {
    creativeA: {
      ...
      copy: "作為專業女性，您照顧家人的同時，有沒有好好照顧自己？保誠全方位高端醫療方案，保費回贈高達20%，讓您安心投入每一天。",
      cta: "了解保費回贈詳情",
      platforms: ["Facebook Ad Integrated", "Instagram Post Ready"],
      ctr: 3.9,
      bounce: 51,
    ...
    creativeB: {
      ...
      copy: "研究顯示：30-50歲女性專業人士醫療支出比同齡男性高出34%。保誠全方位高端醫療方案涵蓋全球5,000+醫院，終身保障上限無限，投保即享保費回贈。",
      cta: "立即計算您的回贈金額",
      platforms: ["Facebook Ad Integrated", "Instagram Post Ready"],
      ctr: 7.1,
      bounce: 28,
    ...
    lead: {
      ...
      capturedSource: "Instagram Ad B Winner",
      followUpSMS:
        "李女士，您好！👩‍💼 感謝您查詢保誠全方位高端醫療方案！作為重視自身保障的專業女性，您值得最好的醫療支援 🏥\n\n✅ 全球5,000+頂級醫院網絡\n✅ 終身保障，無上限賠付\n✅ 投保首年享專屬保費回贈\n✅ 專屬女性健康篩查服務\n\n我們的女性理財顧問將於今天內與您聯絡，為您提供度身訂製方案 💌\n\n保誠香港 | Prudential HK\nhttps://www.prudential.com.hk",
    },
  },
};
...
const CAMPAIGN_BRIEFS = {
  alpha:
    "保誠環球貨幣保障計劃 — 目標客群：20-40歲海外理財新興中產；核心訴求：全球多幣種資產保值；限時優惠：首年保費10%折扣；渠道：Facebook + Instagram精準投放",
    ...
    <div className={`relative rounded-xl border flex flex-col gap-3 overflow-hidden transition-all duration-300 ${
      ...
      <div className="mx-4 bg-slate-50 rounded-lg border border-slate-200 p-3.5">
        <div className="flex items-center gap-2 mb-2.5">
          ...
          <div>
            <p className="text-xs font-semibold text-slate-800">Prudential HK</p>
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-slate-200 shadow-sm">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            {/* Prudential wordmark simulation */}
            <div className="flex items-center gap-1.5">
              <div className="w-7 h-7 rounded flex items-center justify-center text-sm font-black text-white"
                style={{ backgroundColor: PRU_RED }}>
                P
              </div>
              <span className="font-black text-slate-800 text-sm tracking-tight">PRUDENTIAL</span>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-6 pt-12 pb-6">
        <div className="mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4 max-w-2xl">
            Prudential Next-Gen AI MarTech
            <br />
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold text-slate-800 leading-snug">
                          {key === "alpha"
                            ? "保誠環球貨幣保障計劃 (20-40歲海外理財/新興中產/10%保費折扣)"
      ...
      <footer className="border-t border-slate-200 bg-white mt-auto">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-400">Prudential HK · AI MarTech Optimization Loop · PoC Demo</span>
          </div>
